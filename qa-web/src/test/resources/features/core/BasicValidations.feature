...
Feature: Basic Validations on Amazon.com
  ...
  Scenario: Make sure the item price doesn't vary between pages.
    ...
    # details page
    Then The price displayed on the details page should be equal to ""
    When I click on Add to Cart
    # ShoppingCartPreview
    Then "Added to Cart" message is displayed
    Given I click on Cart on navbar
    #ShoppingCart
    Then The price displayed on the Shopping cart page should be equal to ""
  ...
  Scenario: Make sure the item price doesn't vary between pages.
    ...
    When I search "Echo support" on Find more solutions
