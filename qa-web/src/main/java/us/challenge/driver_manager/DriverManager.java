package us.challenge.driver_manager;
...
public final class DriverManager {
    ...
    private static final int MIN_TIME_WAIT = PropertyAccessor.getInstance().getMinTimeWait();
    private static final int MAX_TIME_WAIT = PropertyAccessor.getInstance().getMaxTimeWait();
    ...
    private void initWebDriver() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(MIN_TIME_WAIT));
        driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(MAX_TIME_WAIT));
//        driver.manage().window().maximize();
        wait = new WebDriverWait(driver, Duration.ofSeconds(MIN_TIME_WAIT));
